    ...
    public void event(Player player) {
        ...
        switch (num) {
            case 0:
                ...
                if (id == -1) {
                    IO.print("本来想补助土地最少玩家,但是不存在\"最\",所以不补助了_(:зゝ∠)_");
                    return;
                }
            ...
            case 1:
                ...
                if (id == -1) {
                    IO.print("本来想表扬土地最多玩家,但是不存在\"最\",所以不奖励了_(:зゝ∠)_");
                    return;
                }
                ...
                break;
            case 2:
                IO.print("银行加发储金红利每个人得到存款 10%");
                for (Player i: p) {
                    i.setDeposit((int) (i.getDeposit()*1.1));
                    IO.print("玩家"+i.getName()+"当前存款金额\t"+i.getDeposit());
                }
                break;
            case 3:
                IO.print("所有人缴纳财产税 10%_(:з╂∠)_");
                for (Player i: p) {
            ...
            case 4:
                ...
                IO.print("所有人随机获得道具卡" + Prop.names[random] + "一张");
                for (Player i: p) {
                    i.addCard(random, 1);
                }
                break;
